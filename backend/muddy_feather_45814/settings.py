"""
Django settings for muddy_feather_45814 project.
...
ROOT_URLCONF = 'muddy_feather_45814.urls'
...
WSGI_APPLICATION = 'muddy_feather_45814.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "muddy_feather_45814 API",
    "DESCRIPTION": "API documentation for muddy_feather_45814 App",
    "VERSION": "v1",
}
